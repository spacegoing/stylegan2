'''
This will take a reference image and recreate it using Stylegan2.
Source: https://github.com/rolux/stylegan2encoder/blob/master/project_images.py
'''
...
def main():
    ...
    parser.add_argument('--vgg16-pkl',
                            ...
                            # default='models/vgg16_zhang_perceptual.pkl',
